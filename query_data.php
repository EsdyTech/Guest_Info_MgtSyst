...
.affix {
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li ><a href="myform.php" id = "li">Add Guest</a></li>
      <li><a href="logoutform.php" id = "li">Checked Out Guests</a></li>
	...
	<div id='body'>
		...
		<div class="FormLabel" style="border-top: solid 2px;">		
		 ...
		 <div class="FormLabel" style="border-top: solid 2px;">
		 <label for =" active entries">View all Active Guests : </label><input type = "radio" name = "search"  id="active" value ="active" onclick="disable()">
		 </div>
...
<?php
 ...
 if(isset($_POST["search"]) && $_POST["search"]=="all") 
 {
	...
	if($count){
		echo "<br><h3 style = 'padding-left: 16px;''>Information of all Guests</h3><br/>";
		headingMake($result);
 	...
 	if( empty($_POST["day_start"]) && empty($_POST["day_end"]) && empty($_POST["active"])) {
 	 ...
 	 $count = mysqli_num_rows($result);
 		...
 		if($count){
 			...
 			echo "<br><h3 style = 'padding-left: 16px;''>Guests Information for Active Guests</h3><br/>";
 			headingMake($result);
 ...
 if( empty($_POST["dateP"])|| empty($_POST["dateF"])) 
	 ...
	 if($inputDate[0] == $inputDate[1])
		echo "<br><br><h3 style = 'padding-left: 16px;'>Guests Information for $inputDate[0]-$inputDate[2]-$inputDate[4]<br/></h3>";
	 else
		echo "<br><br><h3 style = 'padding-left: 16px;'>Guests Information from $inputDate[0]-$inputDate[2]-$inputDate[4] to 
